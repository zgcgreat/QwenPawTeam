...
- [2026-04-29] Выпущена версия **v1.1.5**! Полное описание — в [примечаниях к выпуску v1.1.5](https://qwenpaw.agentscope.io/release-notes).
  ...
  - **[v1.1.5] Добавлено**: оптимизация поиска в памяти; резервный механизм сжатия контекста; переименование и удаление ACP-агентов; поддержка голосовых сообщений и ASR в QQ.
  - **[v1.1.5] Производительность**: кэширование конфигов и манифестов навыков; дедупликация API-запросов моделей; виртуализация списка чатов в консоли.
  - **[v1.1.5] Исправлено**: команды одобрения в каналах; нормализация часовых поясов; обработка тайм-аута выполнения MCP.
  - **[v1.1.5] Новые участники**: @LinQi0777, @albert-zen, @ideal, @CA-mambo, @bxy3045134656.
...
- [2026-04-22] Выпущена версия **v1.1.3**! Полное описание — в [примечаниях к выпуску v1.1.3](https://qwenpaw.agentscope.io/release-notes).
