...
- [2026-04-22] Выпущена версия **v1.1.3**! Полное описание — в [примечаниях к выпуску v1.1.3](https://qwenpaw.agentscope.io/release-notes).
  ...
  - **[v1.1.3] Добавлено**: система резервного копирования и восстановления; QwenPaw как ACP-сервер; проактивная отправка сообщений; система плагинов консоли; страница статистики агентов; переключение языка встроенных навыков; защита от обфускации Shell-команд.
  - **[v1.1.3] Изменено**: страница отладки перемещена в раздел «Настройки»; унифицирована медиа-директория каналов; оптимизация скорости запуска.
  - **[v1.1.3] Новые участники**: @daliu858, @xuanrui-L, @pxdawn, @mailmrcai, @linhuang0405, @imrewce, @zealonexp, @Prince-liu.
