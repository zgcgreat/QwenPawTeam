...
LangString qwenpawStopBackendPrompt ${LANG_ENGLISH} "QwenPaw is still running and is using files the installer needs to replace.$\n$\nPlease quit QwenPaw (check the system tray), then click Retry to continue. Click Cancel to abort the installation."
