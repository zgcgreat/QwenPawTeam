...
LangString qwenpawStopBackendPrompt ${LANG_PORTUGUESEBR} "O QwenPaw ainda está em execução e está usando arquivos que o instalador precisa substituir.$\n$\nFeche o QwenPaw (verifique a bandeja do sistema) e clique em Repetir para continuar. Clique em Cancelar para abortar a instalação."
