...
LangString qwenpawStopBackendPrompt ${LANG_RUSSIAN} "QwenPaw всё ещё запущен и использует файлы, которые установщику нужно заменить.$\n$\nЗакройте QwenPaw (проверьте системный трей), затем нажмите «Повторить», чтобы продолжить. Нажмите «Отмена», чтобы прервать установку."
