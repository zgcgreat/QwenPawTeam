...
> Производная работа от [QwenPaw](https://github.com/agentscope-ai/QwenPaw) (MIT License). Превратите однопользовательский QwenPaw в мультиользовательскую платформу с **одной переменной окружения**.
...
# Запустить фронтенд-сервер разработки
pnpm run dev
```

Бэкенд по умолчанию работает на `http://localhost:8000`, фронтенд — на `http://localhost:5173`.
