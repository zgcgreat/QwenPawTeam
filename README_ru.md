...
- [2026-05-19] Выпущена версия **v1.1.8**! Полное описание — в [примечаниях к выпуску v1.1.8](https://qwenpaw.agentscope.io/release-notes).
  ...
  - **[v1.1.8] Добавлено**: официальные ресурсы плагинов (загрузка с сайта + установка одним кликом из консоли); QwenPaw Pet — десктопный питомец; плагин CloudPaw для развёртывания в Alibaba Cloud; команда `/make-skill`; пользовательские HTTP-заголовки и режим аутентификации; настройка контекста для каждой модели; пакетные действия во входящих; закрепление панели истории чата.
